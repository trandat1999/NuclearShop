...
public class SystemMessage {
    public static String CONTENT_MAIL_REGISTER = "Thanks for registering your account. Link activity will be expired after 5 minutes";
    public static String SUBJECT_MAIL_REGISTER = "Verify your email address";
